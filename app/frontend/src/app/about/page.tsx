...
const VALUES = [
  {
    ...
    title: "Real Results",
    description:
      "Every program is built around measurable, personal progress — not generic routines.",
  },
  {
    icon: Users2,
    title: "Community First",
    description:
      "We're a place people show up for each other, not just a set of machines.",
  },
  {
    icon: HeartHandshake,
    title: "Honest Coaching",
    description:
      "Our trainers tell you what you need to hear, not just what's easy.",
  },
  {
    icon: Trophy,
        ...
        <div className="container grid items-center gap-12 lg:grid-cols-2">
          <div className="grid gap-6">
            ...
            <p className="text-muted-foreground leading-relaxed text-sm sm:text-base">
              ...
              a chore. We built a gym around elite trainers, flexible membership
              structures, and a welcoming environment that makes consistency the
              default.
            </p>
            <p className="text-muted-foreground leading-relaxed text-sm sm:text-base">
              Today, PulseFit brings together certified coaches, clean and
              well-maintained equipment, and simple plans — all designed around
              one goal: helping you show up and make progress day after day.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-24">
        <div className="container flex flex-col items-center gap-6 text-center">
          ...
          <p className="max-w-md text-muted-foreground text-sm sm:text-base leading-relaxed">
            The best way to know if PulseFit is right for you is to visit and
            meet our certified training staff.
          </p>
          <div className="flex flex-wrap justify-center gap-4 mt-2">
            <Button
              size="lg"
              className="px-8 font-bold uppercase tracking-wider text-xs py-6 shadow-lg shadow-primary/20"
              asChild
            >
              <Link href="/register">
