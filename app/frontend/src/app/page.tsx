        ...
        <div className="container grid items-center gap-12 lg:grid-cols-12">
          <div className="lg:col-span-7 grid gap-6 text-left">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl xl:text-7xl leading-[1.1] text-balance">
              Train{" "}
              <span className="text-primary text-glow font-black">
                smarter.
              </span>
              <br />
              Live{" "}
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Button
                size="lg"
                className="px-8 font-bold uppercase tracking-wider text-xs py-6 shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all duration-300"
                asChild
              >
                <Link href="/register">
              ...
              <Button
                size="lg"
                variant="secondary"
                className="px-8 font-bold uppercase tracking-wider text-xs py-6 border border-border/80"
                asChild
              >
      ...
      <section className="py-20 relative">
        <div className="container grid gap-12">
          ...
          <div className="flex justify-center mt-4">
            <Button
              variant="outline"
              className="border-border hover:bg-secondary font-bold uppercase tracking-wider text-xs px-6 py-5"
              asChild
            >
              <Link href="/pricing">
        ...
        <div className="container grid gap-12">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {TESTIMONIALS.map((t) => (
              <Card
                key={t.name}
                className="bg-card/40 backdrop-blur border-border/60 hover:border-primary/30 transition-all duration-300"
              >
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-card to-card/60 border border-border p-8 md:p-14 text-center shadow-2xl">
            ...
            <div className="relative z-10 max-w-2xl mx-auto grid gap-6">
              ...
              <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
                Join PulseFit today and get matched with a plan and trainer that
                fits your goals — no long-term contracts.
              </p>
